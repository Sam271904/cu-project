...
function createServer(options) {
    ...
    const db = options?.db ?? (0, db_1.openDb)();
    const apiHandler = (0, api_1.createApiHandler)(db);
    function resolveFrontendDistPath() {
        ...
        for (const c of candidates) {
            const index = node_path_1.default.join(c, 'index.html');
    ...
    const server = node_http_1.default.createServer((req, res) => {
        ...
        if (req.method === 'GET' && !url.startsWith('/api/') && url !== '' && url !== '/health' && url !== '/sw.js' && url !== '/push-demo') {
            ...
            const resolved = node_path_1.default.join(frontendDistPath, relPath);
            ...
            if (node_fs_1.default.existsSync(resolved) && node_fs_1.default.statSync(resolved).isFile()) {
                ...
                node_fs_1.default.createReadStream(resolved).pipe(res);
                return;
            }
...
if (require.main === module) {
    const { port } = (0, config_1.loadAppConfig)();
